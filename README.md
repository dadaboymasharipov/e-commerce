# Web ecommerce application</h1>

This is a web ecommerce application that helps to buy and sell anything online. It has only 2 roles when the system
starts : Owner and User. Later on Owner can create other roles if needed. Owner has all the permissions of the
system.<br>
Here are the permissions:
<ul>
<li>CAN_ADD_ROLE_TO_USER</li>
<li>EDIT_MY_USER</li>
<li>DELETE_USER</li>
<li>BLOCK_USER</li>
<li>UNBLOCK_USER</li>
...
| PUT    | /api/user/addRoleToUser              | users with a privilege: CAN_ADD_ROLE_TO_USER | To give a role to user                                            | userId and roleId as a param                  |
