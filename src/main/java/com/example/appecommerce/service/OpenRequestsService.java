...
public interface OpenRequestsService {
     ...
     */
    HttpEntity<?> getProducts(int pageNum, int pageSize);
     ...
     */
    HttpEntity<?> getProductsByOwner(UUID id, Integer pageNumber, Integer pageSize);
     ...
     */
    HttpEntity<?> getProductsByCategory(UUID id, Integer pageNumber, Integer pageSize);
     ...
     */
    HttpEntity<?> getUsers(Integer pageNumber, Integer pageSize);
}
